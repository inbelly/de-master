...
<#if login_error??>
    ...
    <script>
        ...
        window.fbAsyncInit = function () {
            ...
            FB.init({
                ...
                channelURL: '//inbelly.de/channel.html',
    ...
    <form id="login" name="loginForm" action="loginProcess" class="login clearfix">
        <div class="mt mb clearfix" data-scope="email">
            <a href="login" onclick="loginToFacebook(); return false;"><img
                    src="${cp}images/facebook_login_button.png"/></a>
        </div>
        <div class="field clearfix">
            <label for="f-product"><@spring.message code="login.email"/></label>

            <div class="input">
                <input type="text" name="j_username" onfocus="bUsernameHasFocus = true;"
                       onblur="bUsernameHasFocus = false;" id="username" value="" maxlength="256" size="30"/>
            </div>
        </div>
        <div class="field clearfix">
            ...
            <div class="input">
                <input type="password" name="j_password" onfocus="bPasswordHasFocus = true;"
                       onblur="bPasswordHasFocus = false;" id="password" value="" maxlength="256" size="30"/>
