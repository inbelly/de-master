...
<meta property="og:description" content="<@spring.message code="facebook.metadata.description" />"/>
<meta property="og:image"
      content="<#if (product.label?? && product.label.photo?exists && product.label.photo?length > 0)>http://<@spring.message code="site.domain" />${cp}files/${product.label.photo}<#else/>${cp}images/product.png</#if>"/>
