    ...
    <#if partners?? && 0 < partners?size>
        <#list partners as partner>
            <div class="friend clearfix">
                <#if partner.thumb??><img src="${cp}files/${partner.thumb}" width="110" height="80"
                                          alt="${partner.title}"/></#if>
                <div class="text">
        ...
        <div id="partnerForm" class="addFriend clear clearfix">
            ...
            <div class="clear clearfix">
			                        <span class="toggle fl">
			                            <a href="javascript:void(0);" class="toggle-handle js">
                                            <h4><@spring.message code="friends.partners.add" /></h4></a>
			                        </span>
            </div>
            <@form.form id="addPartner" action="partner/add" modelAttribute="partner" enctype="multipart/form-data">
                <div class="row">
                    <@form.label path="title" cssErrorClass="errorMsg"><@spring.message code="friends.form.name"/>
                        :</@form.label>
                    <@form.input path="title" size="50" maxlength="400" cssErrorClass="error"/>
                    <@form.errors path="title" element="p" cssClass="errorMsg"/>
                </div>
                <div class="row">
                    <@form.label path="url" cssErrorClass="errorMsg"><@spring.message code="friends.form.url"/>
                        :</@form.label>
                ...
                <div class="clear">&nbsp;</div>
                <div class="row">
                    <@form.label path="file" cssErrorClass="errorMsg"><@spring.message code="friends.form.picture"/>
                        :</@form.label>
                ...
                <div class="clear">&nbsp;</div>
                <div class="row">
                    <@form.label path="description" cssErrorClass="errorMsg"><@spring.message code="friends.form.description"/>
                        :</@form.label>
                ...
                <div class="buttonGroup">
                    <p>
                        <input type="submit" name="_eventId_submit" value="<@spring.message code="friends.form.save"/>"
                               id="submitButton"/>
                    </p>
                </div>
            </@form.form>
    ...
    <#if donators?? && 0 < donators?size>
        <#list donators as donator>
            <div class="donator clearfix">
                <div class="image">
                    <#if donator.thumb??><img src="${cp}files/${donator.thumb}" width="40" height="40"
                                              alt="${donator.title}"/></#if>
    ...
    <@sec.authorize ifAllGranted="ROLE_ADMIN">
        <div id="donatorForm" class="addFriend clear clearfix">
            ...
            <div class="clear clearfix">
			                        <span class="toggle fl">
			                            <a href="javascript:void(0);" class="toggle-handle js">
                                            <h4><@spring.message code="friends.donators.add" /></h4></a>
			                        </span>
            </div>
            <@form.form id="addDonator" action="donator/add" modelAttribute="donator" enctype="multipart/form-data">
                ...
                <div class="row">
                    <@form.label path="donationDate" cssErrorClass="errorMsg"><@spring.message code="friends.form.donationDate"/>
                        :</@form.label>
                ...
                <div class="row">
                    <@form.label path="amount" cssErrorClass="errorMsg"><@spring.message code="friends.form.amount"/>
                        :</@form.label>
                    <@form.input path="amount" size="50" maxlength="400" cssErrorClass="error"/>
                    <@form.errors path="amount" element="p" cssClass="errorMsg"/>
                </div>
                <div class="row">
                    <@form.label path="currency" cssErrorClass="errorMsg"><@spring.message code="friends.form.currency"/>
                        :</@form.label>
