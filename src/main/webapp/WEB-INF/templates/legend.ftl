...
<div id="hazards" class="clear clearfix">
    ...
    <#list [4, 3, 2, 1, 0] as no>
        ...
        <li class="<#if no == 4>last </#if>clearfix">
            <a href="${cp}spring/productList/filterByHazard?hazard=${no}"><img src="${cp}images/hazard-${no}.png"
                                                                               width="45" height="45" alt="${shortTxt}"
                                                                               title="${descTxt}"/></a>
...
<script type="text/javascript">
    ...
    (function () {
        ...
        lib.ready(function () {
            ...
            lib.widget.hazards.run(hazards, {show: "More", hide: "Hide"});
        });
    })();
    //]]>
</script>
